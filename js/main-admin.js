...
async function getData() {
  try {
    const character_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/characters`
    );
    ...
    const location_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/locations`
    );
    ...
    const race_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/races`
    );
    ...
    const event_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/events`
    );
    ...
    const period_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/periods`
    );
    ...
    const weapon_response = await fetch(
      `https://arda-wiki-api.onrender.com/api/weapons`
    );
